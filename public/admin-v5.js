...
function switchTabV5(tab){
 ...
 var h='';switch(tab){
  ...
  case'media-interaksi':h=mediaPage();break;case'fitur':h=featuresPage();break;case'pengaturan':h=settingsPage();break;case'integrasi':h=integrationsPage();break;
